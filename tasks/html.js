...
const htmlCommon = () => {
  return gulp
    .src('source/*.html')
    .pipe(replace('"/frontend/build/img/sprite.svg', '"./img/sprite.svg'))
    .pipe(replace('"/local/', '"https://air-bosch.com//local/'))
    .pipe(replace('"/bitrix/', '"https://air-bosch.com//bitrix/'))
    .pipe(replace('"/upload/', '"https://air-bosch.com//upload/'))
    .pipe(replace('"/frontend/', '"https://air-bosch.com//frontend/'))
